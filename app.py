        ...
        if img_file_buffer is not None and ia_lista:
            with st.spinner("Procesando Doble Verificación Cognitiva..."):
                ...
                if "VACIO" in ia_clase.upper():
                    ...
                    # REGLA: Sin código de barras legible, hay pérdida de trazabilidad.
                    decision = f"PÉRDIDA DE TRAZABILIDAD: IA detectó '{ia_clase}', pero no hay Código de Barras legible. Imposible certificar Lote en SAP. Re-etiquetar inmediatamente."
